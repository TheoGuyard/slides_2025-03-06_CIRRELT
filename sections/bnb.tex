...
\begin{frame}{BnB -- Algorithmic principle}
    \begin{tikzpicture}[remember picture,overlay]
        ...
        \onslide<2-> {
            ...
            \foreach \x in {-3,-2,...,3} {
                \foreach \y in {-1.5,-0.5,...,1.5} {
                    \draw[black,fill=black] (\x,\y) circle (0.1cm);
                }
            }
        }
        %
        ...
        %
        \onslide<3-> {
            \draw[ultra thick, fill=gray!40,rotate=30,opacity=0.5] (1,-1) ellipse (1cm and 0.75cm);
...
\begin{frame}{BnB -- Geometrical illustration}
    \AddTodo{XXX}
\end{frame}
        ...
        \begin{scope}[xshift=0.5\textwidth]
            \onslide<1-> {
                ...
                \node[text width=0.475\linewidth,align=center] at ($(problem)+(0,-2)$) {
                    ...
                    \textbf{Pipeline} \\
                    \begin{enumerate}
                        \item[\textbf{1a)}] Implement a specialized BnB
