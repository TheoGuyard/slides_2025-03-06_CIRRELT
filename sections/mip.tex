    ...
    \begin{tikzpicture}[remember picture,overlay]
        \begin{scope}[xshift=0.5\textwidth]
            ...
            \onslide<5-> {
                ...
                \node[align=center,text width=0.375\textwidth,font=\small] (solver) at ($(middle-formulation-solution)+(5,0)$) {\textbf{Off-the-shelf solver} \\ Gurobi, CPLEX, SCIP, \\ Mosek, CbC, ...};
        ...
        \begin{scope}[xshift=0.5\textwidth]
            ...
            \onslide<4-> {
                ...
                \node[text width=0.65\linewidth,align=center,font=\small] at ($(practical-mip)+(5.75,-0.15)$) {
                    ...
                    $\tilde{\pfunc}(\pv,\bv) = 
                    \begin{cases}
                        \pfunc(\pv) &\text{if } \bvi{\idxentry} = \pvi{\idxentry} = 0 \text{ or } \bvi{\idxentry}=1, \forall \idxentry \\
                        +\infty &\text{otherwise}
                    \end{cases}
                    $
                };
